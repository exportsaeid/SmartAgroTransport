...
//import com.smartagrotransport.R;
import com.example.SmartAgroTransport.R;
...
public class InvoiceItemAdapter extends RecyclerView.Adapter<InvoiceItemAdapter.ViewHolder> {
    ...
    // سازنده با ۳ پارامتر — دقیقاً همان که در MainActivity استفاده می‌شود
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvَAddress.setText(item.getAddress());
        ...
        holder.btnRemove.setOnClickListener(v -> {
            if (removeListener != null) {
                ...
                new AlertDialog.Builder(holder.itemView.getContext())
                        .setTitle("حذف محصول")
                        .setMessage("آیا مطمئن هستید که می‌خواهید  حذف کنید؟")
        ...
        if (position % 2 == 0) {
            // سطرهای زوج (0, 2, 4, ...)
            holder.itemView.setBackgroundColor(Color.parseColor("#FFFFFF")); // سفید
        } else {
            // سطرهای فرد (1, 3, 5, ...)
            holder.itemView.setBackgroundColor(Color.parseColor("#F2F2F2")); // خاکستری بسیار روشن
        }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvName, tvMobile, tvَAddress, tvRowTotal;
        ...
        ViewHolder(View itemView) {
            ...
            tvَAddress = itemView.findViewById(R.id.tvَAddress);
